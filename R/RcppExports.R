...
fitsurface <- function(x, y, groups, run_ls, pen_fact, lambda, gamma, shrinkage, alpha, pmax, gmax, active_set, active_set_count, sort, screen, eps, max_cd_iter, max_ls_iter, lips_const, loss_fun) {
    .Call(`_grpsel_fitsurface`, x, y, groups, run_ls, pen_fact, lambda, gamma, shrinkage, alpha, pmax, gmax, active_set, active_set_count, sort, screen, eps, max_cd_iter, max_ls_iter, lips_const, loss_fun)
}
